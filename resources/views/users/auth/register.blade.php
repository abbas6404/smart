...
<head>
    ...
    <title>{{ config('app.name', 'Smart MLM') }} - Register</title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <div class="mx-auto h-12 w-12 bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg flex items-center justify-center">
            ...
            <form class="mt-8 space-y-6" action="{{ route('user.register') }}" method="POST">
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('user.login') }}" class="font-medium text-green-600 hover:text-green-500">
                            Sign in here
                        </a>
                    </p>
                </div>
